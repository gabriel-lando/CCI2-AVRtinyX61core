...
route_special -connect {block_pin core_pin pad_pin pad_ring floating_stripe} -layer_change_range {M1 M6} -block_pin_target {nearest_target} -pad_pin_port_connect {all_port one_geom} -block_pin {use_lef} -allow_jogging 1  -crossover_via_layer_range {M1 M6} -allow_layer_change 1 -target_via_layer_range {M1 M6} -nets {gnd vdd}

##Add well taps
add_well_taps -cell FEED3 -cell_interval 20 -fixed_gap -prefix WELLTAP -in_row_offset 8.0
